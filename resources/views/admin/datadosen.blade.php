            ...
            <div class="col-6">
                <form action="{{ route('admin.datadosen') }}" method="GET">
                    ...
                    <div class="input-group">
                        <input type="search" name="search" class="form-control rounded" placeholder="Cari Data Dosen"
            ...
            <tbody class="table-group-divider">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-outline-danger" href="/admin/deleteDataDosen/{{ $datadosen->id }}"><i
